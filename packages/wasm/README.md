<<<<<<< HEAD:packages/wasm/README.md
Complies the go interpreter into wasm with browser specific modificaitons to allow the interpreter to function in a browser environment
---
...
>>>>>>> main:packages/nuru-wasm/README.md
